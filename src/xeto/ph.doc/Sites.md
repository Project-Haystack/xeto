...
Core tags used with sites:
  ...
  - [ph::PhEntity.geoAddr]: the geographic free-form address of the site (which might
    include other geolocation tags such as `geoCity` or `geoCoord`)
  - [ph::PhEntity.tz]: the timezone where the site is located
  - [ph::PhEntity.area]: square footage or square meters of the facility. This enables
    site normalization by area.
  - [ph::PhEntity.weatherStationRef]: associate the site with a weather station to visualize
    weather conditions and perform weather based energy normalization
  - [ph::PhEntity.yearBuilt]: four digit year in which the building was constructed
