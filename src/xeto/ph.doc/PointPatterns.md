...
position with [ph.points::DamperModulatingCmd] and its actual position is sensed
with [ph.points::DamperModulatingSensor].  Comparing the pair detects failures
